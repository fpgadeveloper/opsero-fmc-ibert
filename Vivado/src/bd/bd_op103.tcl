...
# Create constant LOW for the HOST_MODE_N (enable host mode) and LOCAL_CLKS_N (use local clocks)
set const_low [ create_bd_cell -type inline_hdl -vlnv xilinx.com:inline_hdl:ilconstant:1.0 const_low ]
set_property -dict [list CONFIG.CONST_VAL {0} CONFIG.CONST_WIDTH {1}] $const_low
create_bd_port -dir O host_mode_n
connect_bd_net [get_bd_pins const_low/dout] [get_bd_ports host_mode_n]
create_bd_port -dir O local_clks_n
connect_bd_net [get_bd_pins const_low/dout] [get_bd_ports local_clks_n]
